...
def analyze_dataset(filename, component_name):
    ...
    # DEBUG: see what pandas actually loaded
    ...
    # ✅ ROBUST target detection (no naming issues)
    ...
    if not feature_cols:
        print("⚠️ No feature columns found (only target + date)")
        return df, target_col, feature_cols, None
...
for component, filename in [
    ...
    ('platelet', 'scaled_platelets_demand.csv'),
